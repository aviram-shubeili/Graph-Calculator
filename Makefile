...
PyInterface.o: PyInterface.cpp PyInterface.h Auxiliaries.h Graph.h Calc.h \
 GraphExceptions.h Exceptions.h CalcExceptions.h
	$(CC) -fPIC -c $(DEBUG_FLAG) $(COMP_FLAG) PyInterface.cpp
...
swig: libgraph.a
	...
	g++ -std=c++11 -DNDEBUG --pedantic-errors -Wall -Werror -I/usr/local/include/python3.6m -fPIC -shared graph_wrap.cpp libgraph.a -o _graph.so
